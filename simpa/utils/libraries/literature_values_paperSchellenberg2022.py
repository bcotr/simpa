...
class OpticalTissueProperties:
    ...
    VENOUS_OXYGENATION_LOWER = 0.6
    VENOUS_OXYGENATION_UPPER = 0.8
    ...
    ARTERIAL_OXYGENATION_LOWER = 0.9
    ARTERIAL_OXYGENATION_UPPER = 1.0
...
class MorphologicalTissueProperties:
    ...
    values were derived for tissue modelling.
    """
    ARTERY_ECCENTRICITY_LOWER = 0
    ARTERY_ECCENTRICITY_UPPER = 0.8
    VEIN_ECCENTRICITY_LOWER = 0.3
    VEIN_ECCENTRICITY_UPPER = 0.9
    ...
    #
    artery_diameter_mean_mm = {}
    artery_diameter_std_mm = {}
    vein_diameter_mean_mm = {}
    vein_diameter_std_mm = {}
    #
    artery_diameter_mean_mm["radial"] = RADIAL_ARTERY_DIAMETER_MEAN_MM
    artery_diameter_std_mm["radial"] = RADIAL_ARTERY_DIAMETER_STD_MM
    artery_diameter_mean_mm["ulnar"] = ULNAR_ARTERY_DIAMETER_MEAN_MM
    artery_diameter_std_mm["ulnar"] = ULNAR_ARTERY_DIAMETER_STD_MM
    artery_diameter_mean_mm["interosseus"] = MEDIAN_ARTERY_DIAMETER_MEAN_MM
    artery_diameter_std_mm["interosseus"] = MEDIAN_ARTERY_DIAMETER_STD_MM
    #
    #
    vein_diameter_mean_mm["radial"] = RADIAL_VEIN_DIAMETER_MEAN_MM
    vein_diameter_std_mm["radial"] = RADIAL_VEIN_DIAMETER_STD_MM
    vein_diameter_mean_mm["ulnar"] = ULNAR_VEIN_DIAMETER_MEAN_MM
    vein_diameter_std_mm["ulnar"] = ULNAR_VEIN_DIAMETER_STD_MM
    vein_diameter_mean_mm["interosseus"] = MEDIAN_VEIN_DIAMETER_MEAN_MM
    vein_diameter_std_mm["interosseus"] = MEDIAN_VEIN_DIAMETER_STD_MM
    #
    ...
    EPIDERMIS_THICKNESS_MEAN_MM = 0.2
    ...
    RADIAL_ARTERY_DEPTH_MEAN_MM = 4.0
    RADIAL_ARTERY_DEPTH_STD_MM = 0.1
    ULNAR_ARTERY_DEPTH_MEAN_MM = 4.0
    ULNAR_ARTERY_DEPTH_STD_MM = 0.1
    MEDIAN_ARTERY_DEPTH_MEAN_MM = 9.5
    MEDIAN_ARTERY_DEPTH_STD_MM = 0.5
    
    #
    artery_zpos_mean_mm = {}
    artery_zpos_std_mm = {}
    #
    artery_zpos_mean_mm["radial"] = RADIAL_ARTERY_DEPTH_MEAN_MM
    artery_zpos_std_mm["radial"] = RADIAL_ARTERY_DEPTH_STD_MM
    artery_zpos_mean_mm["ulnar"] = ULNAR_ARTERY_DEPTH_MEAN_MM
    artery_zpos_std_mm["ulnar"] = ULNAR_ARTERY_DEPTH_STD_MM
    artery_zpos_mean_mm["interosseus"] = MEDIAN_ARTERY_DEPTH_MEAN_MM
    artery_zpos_std_mm["interosseus"] = MEDIAN_ARTERY_DEPTH_STD_MM
    #
