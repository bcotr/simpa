...
from simpa.utils import Settings, Tags, get_functional_from_deformation_settings, round_x5_away_from_zero, create_deformation_settings
...
class GeometricalStructure:
    ...
    def __init__(self, global_settings: Settings,
        ...
        volume_x_dim = round_x5_away_from_zero(global_settings[Tags.DIM_VOLUME_X_MM] / self.voxel_spacing)
